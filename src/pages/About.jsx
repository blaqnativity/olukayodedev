  ...
  return (
    <>
      <motion.section
        ...
        class="relative min-h-screen bg-primary pt-10 px-6 flex flex-col md:flex-row items-center justify-between gap-8"
      >
        {/* <!-- Left Side: Image --> */}
        ...
        <div class="w-full md:w-7/12 text-center md:text-left relative">
          ...
          <div class="absolute left-[40%] -top-6 md:-left-16 text-gray-900  lg:top-0 md:top-6 rotate-0 md:rotate-[-90deg] text-sm tracking-widest">
            <div class="flex items-center justify-center gap-2">
              <div class="w-16 h-[2px] bg-gray-700"></div>
              <p>MEET ME</p>
            </div>
          </div>

          {/* <!-- Main Heading --> */}
          <h2 class="text-gray-700 text-3xl md:text-5xl font-bold leading-tight mb-4 pl-10">
          ...
          <div className="flex flex-col gap-2 justify-center md:justify-start md:items-start mt-5 text-gray-700">
            <span className="font-medium">Name: Olukayode Asemudara</span>
